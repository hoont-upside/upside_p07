...
contract BeaconPracticeTest {
    ...
    function _assertReinitializeFails(BeaconProxy p1, BeaconProxy p2) internal {
        ...
        require(!ok1, "TODO: proxy A reinitialize must fail");
        require(!ok2, "TODO: proxy B reinitialize must fail");
    }
    ...
    function _assertAttackerCannotUpgrade(
        ...
        require(!ok, "TODO: unauthorized beacon upgrade must fail");
    }

    // TODO(student): owner upgrades the beacon to V2.
    function _upgradeAsOwner(UpgradeableBeacon beacon, BeaconBoxV2 implV2) internal {
